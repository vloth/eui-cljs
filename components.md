...
| `logicalStyle`<br>`logicalSizeStyle`<br>`logicalTextAlignStyle`<br>`LOGICAL_PROPERTIES`<br>`logicalSide`<br>`logicalTextAlignCSS`<br>`logicalSizeCSS`<br>`LOGICAL_SIDES`<br>`logicalCSSWithFallback`<br>`logicalCSS`<br>`LOGICAL_TEXT_ALIGNMENT`<br>`logicalText`<br>`logicals` | `eui.global.logicals` | `node_modules/@elastic/eui/lib/global_styling/functions/logicals.js` |
...
| `euiAnimFadeIn` | `eui.global.animations` | `node_modules/@elastic/eui/lib/global_styling/utility/animations.js` |
...
| `SIZES`<br>`EuiBetaBadge`<br>`COLORS` | `eui.beta-badge` | `node_modules/@elastic/eui/lib/components/badge/beta_badge/beta_badge.js` |
...
| `darken`<br>`tint`<br>`shadeOrTint`<br>`lightness`<br>`desaturate`<br>`transparentize`<br>`saturate`<br>`tintOrShade`<br>`shade` | `eui.services.manipulation` | `node_modules/@elastic/eui/lib/services/color/manipulation.js` |
...
| `EuiThemeContext`<br>`defaultComputedTheme`<br>`EuiColorModeContext`<br>`EuiSystemContext`<br>`EuiModificationsContext` | `eui.color-mode-context` | `node_modules/@elastic/eui/lib/services/theme/context.js` |
